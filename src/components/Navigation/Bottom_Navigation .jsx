...
function Bottom_navigation () {
  ...
  return (
    <div>
        ...
        <div>
            <div className="fixed duration-200 z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 sm:rounded-full bottom-0 sm:bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
